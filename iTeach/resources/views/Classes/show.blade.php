...
<div class="row">
    <div class="col-4 border-right">
        <div class="card border-bottom-primary shadow h-100 py-40">
            ...
            {{-- <img style="transform:translate(6vw,-7vw);" src="{{ asset('profile-pic/' . $class->profile_image) }}" width="200px" height="200px"/> --}}
            <div class="card-body">
                <h1 class="mb-0">{{$class->title}}</h1>
                <br>
                <h2>Description: {{$class->description}}</h2>
                <h3>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        ...
                                        <form action="{{ route('remove.student', [$class->id, $student->id]) }}"
                                            ...
                                            <button type="submit"
                                                    ...
                                                    style="color: #ffffff;"><i class="fa fa-trash" style="display: inline"></i>
                                            </button>
                                        </form>
                                    </td>
                                </tr>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <select class="tom-select w-full mt-1" name="studentName" id="studentName" required>
                                    ...
                                    <option value="{{ $allstudent->id }}">{{ $allstudent->user->name }} {{ $allstudent->user->email }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
